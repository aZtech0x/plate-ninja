...
Loop will iterate over the inventory, ensuring always the largest plate is used when possible.
Weight displays absolute load as text as well as a colour coded visual of the plate and barbell.
